...
vopt work.top +cover=fcbest -o proc_reg_read_test -assertdebug

vsim -c -coverage -assertdebug proc_reg_read_test \
-sv_lib C:/questasim64_2024.1/uvm-1.2/win64/uvm_dpi \
+UVM_TESTNAME=proc_reg_read_test
coverage save -onexit PROC_REG_READ_TEST.ucdb
run -all
quit
