...
vopt work.top +cover=fcbest -o mac_tx_rx_test -assertdebug

vsim -c -coverage -assertdebug mac_tx_rx_test \
-sv_lib C:/questasim64_2024.1/uvm-1.2/win64/uvm_dpi \
+UVM_TESTNAME=mac_tx_rx_test
coverage save -onexit MAC_TX_RX_TEST.ucdb
run -all
quit
